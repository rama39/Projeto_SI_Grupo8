...
function setup() {
  ...
  botaoBFS = botao(150, 610, 'BFS', ()=>{mudaBusca('BFS')});
  botaoDFS = botao(200, 610, 'DFS', ()=>{mudaBusca('DFS')});
  botaoCst = botao(250, 610, 'Custo Uniforme', ()=>{mudaBusca('Custo Uniforme')});
  botaoGul = botao(370, 610, 'Gulosa', ()=>{mudaBusca('Gulosa')});
  botaoASt = botao(440, 610, 'A*', ()=>{mudaBusca('A*')});
